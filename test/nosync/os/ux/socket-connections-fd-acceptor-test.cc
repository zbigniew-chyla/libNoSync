...
using nosync::os::ux::make_full_socket_connections_fd_acceptor;
using nosync::os::ux::make_socket_connections_fd_acceptor;
using nosync::os::ux::owned_fd;
using nosync::os::ux::shared_fd;
using std::array;
...
TEST(NosyncSocketConnectionsFdAcceptor, CheckSingleAccept)
{
    ...
    const auto sock_data = array<char, 2>{'\xA9', '\xC1'};
