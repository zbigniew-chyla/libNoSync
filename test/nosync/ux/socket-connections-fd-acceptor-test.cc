...
#include <nosync/ux/fd-watcher-mock.h>
...
using nosync::ux::fd_watcher_mock;
using nosync::ux::make_full_socket_connections_fd_acceptor;
using nosync::ux::make_socket_connections_fd_acceptor;
