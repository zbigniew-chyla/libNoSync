...
#ifndef NOSYNC_UX__FULL_FD_WATCHING_EVENT_LOOP_MOCK_H
#define NOSYNC_UX__FULL_FD_WATCHING_EVENT_LOOP_MOCK_H
...
#endif /* NOSYNC_UX__FULL_FD_WATCHING_EVENT_LOOP_MOCK_H */
