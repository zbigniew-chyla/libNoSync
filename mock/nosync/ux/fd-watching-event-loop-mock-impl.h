...
#ifndef NOSYNC_UX__FD_WATCHING_EVENT_LOOP_MOCK_IMPL_H
#define NOSYNC_UX__FD_WATCHING_EVENT_LOOP_MOCK_IMPL_H
...
#endif /* NOSYNC_UX__FD_WATCHING_EVENT_LOOP_MOCK_IMPL_H */
