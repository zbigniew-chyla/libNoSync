...
#ifndef NOSYNC__UX__FD_WATCHING_EVENT_LOOP_MOCK_IMPL_H
#define NOSYNC__UX__FD_WATCHING_EVENT_LOOP_MOCK_IMPL_H
...
#endif /* NOSYNC__UX__FD_WATCHING_EVENT_LOOP_MOCK_IMPL_H */
