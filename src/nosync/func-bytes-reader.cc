...
{
public:
    explicit func_bytes_reader(function<void(size_t, eclock::duration, result_handler<string>)> &&reader_func);
...
private:
    function<void(size_t, eclock::duration, result_handler<string>)> reader_func;
};
