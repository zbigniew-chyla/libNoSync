...
#ifndef NOSYNC__OS__UX__THREADED_REQUEST_HANDLER_IMPL_H
#define NOSYNC__OS__UX__THREADED_REQUEST_HANDLER_IMPL_H
...
#endif /* NOSYNC__OS__UX__THREADED_REQUEST_HANDLER_IMPL_H */
