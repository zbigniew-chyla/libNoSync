...
#ifndef NOSYNC_UNIX__PIPED_PROGRAM_HEX_REQUEST_HANDLER_H
#define NOSYNC_UNIX__PIPED_PROGRAM_HEX_REQUEST_HANDLER_H
...
#endif /* NOSYNC_UNIX__PIPED_PROGRAM_HEX_REQUEST_HANDLER_H */
