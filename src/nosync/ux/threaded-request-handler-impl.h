...
#ifndef NOSYNC_UNIX__THREADED_REQUEST_HANDLER_IMPL_H
#define NOSYNC_UNIX__THREADED_REQUEST_HANDLER_IMPL_H
...
#endif /* NOSYNC_UNIX__THREADED_REQUEST_HANDLER_IMPL_H */
