...
#ifndef NOSYNC_UNIX__SOCKET_CONNECTIONS_FD_REQUESTER_H
#define NOSYNC_UNIX__SOCKET_CONNECTIONS_FD_REQUESTER_H
...
#endif /* NOSYNC_UNIX__SOCKET_CONNECTIONS_FD_REQUESTER_H */
